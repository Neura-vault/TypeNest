-- ============================================================
-- 0015: Wire up char_stats and practice_sessions
-- Both tables, and their RLS policies, have existed since migration 0002.
-- The Train page has been reading from char_stats this whole time (see
-- app/train/page.tsx's weakKeys query) — nothing was ever writing to it,
-- so that part of the AI Coach silently never had anything to show.
-- practice_sessions was the same story: schema and policy, zero writers.
-- ============================================================

drop function if exists public.submit_test(text, text, text, int, int, numeric, numeric, numeric, numeric, int, int, int, boolean, boolean);
